...
!**********************************************************************
     ...
     &      FRHIGH, OUTFRHIGHFLAG, OUTFRHIGH, NUMSIG, FILEGRID, IGRIDTYPE, &
     &      LSLOP, SLMAX, LVAR1D, LOPTSIG, CART2LATLON, LATLON2CART,       &
     &      APPLY_DXP_CORR, USE_EXACT_FORMULA_SPHERICAL_AREA, LEXPORT_GRID_MOD_OUT
