...
!         write(DBG%FHNDL,'(6F15.8)') outpar(1:6)
         ...
         OUTPAR(32) = SBR(IP,1) ! KM: deficit due to wave breaking
         OUTPAR(33) = SBR(IP,2) ! KM: local B coefficient used in TG83 and derived models
         OUTPAR(34) = GAMMA(IP) ! KM: breaker index 
         !OUTPAR(35) = TANBETA_X(IP) ! Bed slope in the wave direction
