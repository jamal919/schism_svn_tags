...
!  ifort -cpp -O2 -assume byterecl -o combine_output11.WW ../UtilLib/argparse.f90 combine_output11.f90 ../UtilLib/schism_geometry.f90 -I$NCDIR/include -I$NFDIR/include -L$NFDIR/lib -L$NCDIR/lib -lnetcdf -lnetcdff
